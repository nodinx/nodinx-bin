...
class CovCommand extends Command {
  ...
  * run(context) {
    ...
    if (fs.existsSync(`${coverageDir}/cobertura-coverage.xml`)) {
      debug('Rename cobertura-coverage.xml to cobertura.xml');
      fs.renameSync(`${coverageDir}/cobertura-coverage.xml`, `${coverageDir}/cobertura.xml`);
    }
